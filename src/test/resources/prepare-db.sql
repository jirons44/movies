...
INSERT INTO `movies`.`movies` (`version`, `name`, `released`, `created_at`, `updated_at`, `genre`, `rating`, `studio_id`)
VALUES
...
INSERT INTO `movies`.`actors` (`version`, `name`, `birthday`, `created_at`, `updated_at`, `gender`)
VALUES
...
INSERT INTO `movies`.`actors_movies` (`actor_id`, `movie_id`)
VALUES
  (1, 1),
  (2, 1),
  (3, 1),
